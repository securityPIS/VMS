...
// Catatan konfirmasi hanya tampil & wajib untuk kunjungan terjadwal (SCHEDULE);
// untuk kedatangan langsung (NOW) cukup isi nomor kartu.
import ModalBase from '../../components/ModalBase';
import Button from '../../components/Button';
import InputField from '../../components/InputField';
import { visitScheduleStatus } from '../../lib/constants';
...
const CheckInModal = ({
  ...
  const isSchedule = visitScheduleStatus(visit) === 'SCHEDULE';
  const canConfirm = !!cardNumber && (!isSchedule || !!String(confirmNotes || '').trim());
