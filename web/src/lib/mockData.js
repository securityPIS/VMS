...
export const MOCK_VISITS = [
  ...
  { id: 'V-103', name: 'Budi Hartono', asal: 'Kurir Spesial', keperluan: 'Kirim Dokumen Rahasia', tujuan: 'Direksi', time: '09:15', date: '2026-06-19', status: 'PENDING', scheduleType: 'SCHEDULE', scheduledDate: '2026-06-20', scheduledAt: '2026-06-20T00:00:00+07:00', ktpPhoto: 'https://images.unsplash.com/photo-1621974737299-4c2f6d2e6123?w=150&h=100&fit=crop', selfiePhoto: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop', location: 'Lobi Resepsionis' },
  { id: 'V-106', name: 'Riko Maulana', asal: 'PT Vendor Safety', keperluan: 'Audit peralatan HSSE', tujuan: 'Tim HSSE', time: '10:25', date: '2026-06-19', status: 'PENDING', scheduleType: 'NOW', ktpPhoto: 'https://images.unsplash.com/photo-1589578527966-fdac0f44566c?w=150&h=100&fit=crop', selfiePhoto: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150&h=150&fit=crop', location: 'Gate Utama' },
